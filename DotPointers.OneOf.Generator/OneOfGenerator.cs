...
namespace DotPointers.OneOf.Generator
{
	...
	public class OneOfGenerator : IIncrementalGenerator
	{
		...
		public void Initialize(IncrementalGeneratorInitializationContext context)
		{
			...
			context.RegisterSourceOutput(targets, static (spc, model) =>
			{
				...
				{
					var jsonSource = GenerateSystemJsonSource(model);
				...
				{
					var jsonSource = GenerateNewtonsoftJsonSource(model);
				...
				{
					var jsonSource = GenerateMemoryPackSource(model);
		...
		private static string GenerateSystemJsonSource(GenerationModel model)
		{
		...
		private static string GenerateNewtonsoftJsonSource(GenerationModel model)
		{
		...
		private static string GenerateMemoryPackSource(GenerationModel model)
		{
	...
	{
		public GenerationModel(string @namespace, string name, string fullName, string typeKind, bool allowEmpty, OneOfLayoutKind requestedLayout, bool isGeneric, bool isRef, ImmutableArray<TypeInfoModel> typeArgs, ImmutableArray<string> fieldNames, Serialization serialization)
		{
			Namespace = @namespace;
			Name = name;
			FullName = fullName;
	...
	{
		public static readonly GenerationModelComparer Instance = new GenerationModelComparer();
